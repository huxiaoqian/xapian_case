...
if XAPIAN_INDEX_SCHEMA_VERSION == 2:
    ...
    XAPIAN_ZMQ_VENT_PORT = 5580
    XAPIAN_ZMQ_CTRL_VENT_PORT = 5581
...
if PROD_VENV:
    ...
    if FROM_CSV:
        if XAPIAN_INDEX_SCHEMA_VERSION == 5:
            CSV_FILEPATH = '/home/ubuntu8/dev/original_data/csv/flow/'  # 文件夹时末尾需要/
else:
