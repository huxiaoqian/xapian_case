...
XAPIAN_ZMQ_VENT_HOST = '192.168.1.1' # vent and control host
XAPIAN_ZMQ_VENT_PORT = 5580 # vent port
XAPIAN_ZMQ_CTRL_VENT_PORT = 5581 # control port
XAPIAN_DB_PATH = 'master_timeline_weibo_csv'
XAPIAN_DATA_DIR = '/mnt/ds600/share/weibo_201309/xapian_case/data/'
XAPIAN_STUB_FILE_DIR = '/mnt/ds600/share/weibo_201309/xapian_case/stub/'
...
FROM_CSV = 1
if FROM_CSV:
    CSV_FILEPATH = '/mnt/ds600/share/weibo_201309/csv/flow/'
